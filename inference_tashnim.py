...
def main():
    ...
    assert dataset_type in ['VOC', 'COCO', 'CityScapes', 'ADE20K', 'UAV', 'Michael', 'CReSIS']
...
def parse_arguments():
    ...
    parser.add_argument('-m', '--model', default='saved/DeepLab/08-14_16-52/best_model.pth', type=str,
                        help='Path to the .pth model checkpoint to be used in the prediction')
    parser.add_argument('-i', '--images', default='G:/My Drive/Debvrat_Research/Dataset/Snow Radar/2012_main_dv/test/image', type=str,
                        help='Path to the images to be segmented')
    parser.add_argument('-o', '--output', default='outputs_tashnim', type=str,  
                        help='Output Path')
