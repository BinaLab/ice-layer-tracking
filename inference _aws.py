...
def main():
    ...
    root_path = os.path.join(args.dataset)
...
def parse_arguments():
    ...
    parser.add_argument('-m', '--model', default='saved/DeepLab/07-03_17-48/best_model.pth', type=str,
                        help='Path to the .pth model checkpoint to be used in the prediction')
    parser.add_argument('-d', '--dataset', default='2012_main', type=str, # @dv, added: 2012_main or 2012_cropped
                        help='which data to be segmented - 2012_main or 2012_cropped')
    parser.add_argument('-dt', '--data_type', default='test', type=str, # @dv, added: training set or test set of CReSIS
